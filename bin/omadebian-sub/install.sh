...
if [[ "$CHOICE" == "<< Back"* ]] || [[ -z "$CHOICE" ]]; then
  ...
  case "$INSTALLER" in
  "dev-editor") INSTALLER_FILE="$OMADEBIAN_PATH/bin/omadebian-sub/install-dev-editor.sh" ;;
  "web-apps") INSTALLER_FILE="$OMADEBIAN_PATH/install/desktop/optional/select-web-apps.sh" ;;
