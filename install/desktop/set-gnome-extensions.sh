...
sudo cp ~/.local/share/gnome-shell/extensions/appindicatorsupport\@rgcjonas.gmail.com/schemas/org.gnome.shell.extensions.appindicatorsupport.gschema.xml /usr/share/glib-2.0/schemas/
