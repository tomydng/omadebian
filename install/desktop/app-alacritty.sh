...
cp ~/.local/share/omadebian/configs/alacritty.toml ~/.config/alacritty/alacritty.toml
...
cp ~/.local/share/omadebian/themes/tokyo-night/alacritty.toml ~/.config/alacritty/theme.toml
cp ~/.local/share/omadebian/configs/alacritty/fonts/JetBrainsMono.toml ~/.config/alacritty/font.toml
...
source ~/.local/share/omadebian/install/desktop/set-alacritty-default.sh
